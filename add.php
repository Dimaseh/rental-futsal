...
<header>
    ...
    <main>
        ...
        <div class="d-flex justify-content-center mt-5">
         ...
         <form class="container row g-3" action="insert.php" method="post">
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="number" class="form-control" id="durasi" name="durasi" placeholder="durasi sewa (*jam)" required>
                    <label for="durasi">Durasi Sewa(*jam)</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-floating mb-3">
                    <select class="form-select" id="no_lapangan" name="no_lapangan">
