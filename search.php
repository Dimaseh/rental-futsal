...
// Searching
$query = mysqli_query($connect, "SELECT * FROM booking WHERE nama LIKE '%$keyword%' OR no_telepon LIKE '%$keyword%' OR tanggal LIKE '%$keyword%' OR waktu LIKE '%$keyword%' OR durasi LIKE '%$keyword%' OR no_lapangan LIKE '%$keyword%' OR harga LIKE '%$keyword%' ");
